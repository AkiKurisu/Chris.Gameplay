...
public static class NativeGallery
{
	...
	public static void SaveToGalleryInternal( string path, string album, MediaType mediaType, MediaSaveCallback callback )
	{
#if !UNITY_EDITOR && UNITY_ANDROID
	...
	public static string GetTemporarySavePath( string filename )
	{
